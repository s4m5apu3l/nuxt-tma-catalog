	...
	<UCard>
		...
		<div class="space-y-4">
			...
			<div class="flex gap-2">
				<UButton @click="isEditing = true" :disabled="isLoading">
					{{ $t('common.edit') }}
				</UButton>

				<UButton color="red" variant="outline" @click="emit('delete', category.$id)">
					{{ $t('common.delete') }}
				</UButton>
			</div>
		</div>
...
<!-- Bad -->
<template>
	<div style="margin-top: 20px; color: red;">Content</div>
</template>

<!-- Good -->
<template>
	<div class="mt-5 text-red-500">Content</div>
</template>
```
