...
describe('useCategories', () => {
	...
	describe('fetchCategories', () => {
		it('should successfully fetch categories', async () => {
			...
			expect(mockDatabases.listDocuments).toHaveBeenCalledWith('test-db', 'test-categories', ['orderAsc(name)'])
	...
	describe('getCategoryById', () => {
		it('should successfully get category by ID', async () => {
			...
			expect(mockDatabases.getDocument).toHaveBeenCalledWith('test-db', 'test-categories', '123')
	...
	describe('getCategoryBySlug', () => {
		it('should successfully get category by slug', async () => {
			...
			expect(mockDatabases.listDocuments).toHaveBeenCalledWith('test-db', 'test-categories', [
	...
	describe('createCategory', () => {
		...
		it('should auto-generate slug when not provided', async () => {
			...
			expect(mockDatabases.createDocument).toHaveBeenCalledWith('test-db', 'test-categories', 'unique-id', {
				name: 'New Category',
				slug: 'new-category'
			})
		})
	...
	describe('updateCategory', () => {
		it('should successfully update category', async () => {
			...
			expect(mockDatabases.updateDocument).toHaveBeenCalledWith('test-db', 'test-categories', '123', updateData)
	...
	describe('deleteCategory', () => {
		it('should successfully delete category', async () => {
			...
			expect(mockDatabases.deleteDocument).toHaveBeenCalledWith('test-db', 'test-categories', '123')
